...
import { getIsssueInteractions } from "@/http/get-issue-interactions";
import { useQuery } from "@tanstack/react-query";
import { ArchiveIcon, MessageCircleIcon } from "lucide-react";
import { useMemo } from "react";
import z from "zod";

interface BoarContentProps {
  issues: z.infer<typeof IssuesListResponseSchema>
}

export function BoarContent({ issues }: BoarContentProps) {
  const allIssuesIds = [
  ...
  const { data: interactionsData, isLoading: isLoadingInteraction } = useQuery({
    ...
    queryFn: () => getIsssueInteractions({ issuesIds: allIssuesIds })
  });
